    ...
    dropdown_8_options: [
        {
			...
			choice_options: ['blau', 'rosa', 'rot', 'grün', 'gelb', 'lilas', 'orange', 'weinrot'],
            right_answer: 'blau',
        },
        {
...
const part_three_trial_info = {
    rating_scale: [
        ...
        // All False
        {
            QUD: 'Focus on the shape color', 
			picture: 'images/SPR/Test-1/AllFalse/1a.png',
			listNumber: 1,
			picture_type: 'A',
            question: 'How appropriate was the previous sentence as a description of the image?',
            sentence: 'Alle | der | Dreiecke | auf dem Bild | sind | orange',
            optionLeft: 'Inappropriate',
            optionRight: 'Appropriate', 
        ...
        // All False
        {
            QUD: 'Focus on the shape position', 
